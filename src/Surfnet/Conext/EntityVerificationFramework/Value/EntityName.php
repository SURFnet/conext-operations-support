...
final class EntityName
{
    ...
    {
        Assert::allString($data, 'Entity name must contain array of translations', $propertyPath . '[]');
        Assert::allString(
            array_keys($data),
            'Entity name translations must be indexed by locale',
            $propertyPath . '[]'
        );
    ...
    /**
     * @param EntityName $other
     * @return bool
     */
    public function equals(EntityName $other)
    {
