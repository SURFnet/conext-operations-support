...
class WhitelistAllTest extends UnitTest
{
    /**
     * @test
     * @group Whitelist
     */
    public function always_contains_suites()
    {
        $whitelist = new WhitelistAll();
        $this->assertTrue(
            $whitelist->contains(m::mock('Surfnet\Conext\EntityVerificationFramework\Api\VerificationSuite'))
        );
    }
}
