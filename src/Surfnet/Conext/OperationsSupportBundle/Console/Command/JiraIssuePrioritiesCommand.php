...
final class JiraIssuePrioritiesCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this->setName('operations-support:jira:issue-priorities');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        VarDumper::dump($apiClient->getPriorties());
    }
}
